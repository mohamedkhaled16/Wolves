...
$.post("ajax/do-delete-product.php",
    {
        product_id: PID,
...
<div class="table-responsive">
		...
		foreach($result as $row) {
				...
				echo 'Unavailble<a href="javascript:void(0);" class="text-danger" onclick="changeProudctStatusAvail('.$product_id.')" id="status'.$product_id.'"><i class="fa fa-toggle-on fa-3x"></i></a>';}
				else{
				echo 'Available<a href="javascript:void(0);" class="text-success" onclick="changeProudctStatusUnAvail('.$product_id.')" id="status'.$product_id.'"><i class="fa fa-toggle-on fa-3x"></i></a>';
				}
