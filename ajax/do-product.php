...
//*********Delete*********//	
  if(!isset($_POST['product_id']) || empty($_POST['product_id']) ){echo "0";}
		else {
		
			$result=$admin->delete_product($product_id);
			if ($result != false) {    
			    echo "1";
			 }else{echo "0";}
		}
...
//*********EditAvail*********//		
   if(!isset($_POST['product_unavail']) || empty($_POST['product_unavail']) ){echo "0";}
		else {
		
			$result=$admin->change_product_status_unavail($product_id);
			if ($result != false) {    
			    echo "1";
			 }else{echo "0";}
		}
...
//*********EditUnAvial*********//		
  if(!isset($_POST['product_avail']) || empty($_POST['product_avail']) ){echo "0";}
		else {
		
			$result=$admin->change_product_status_avail($product_id);
			if ($result != false) {    
			    echo "1";
			 }else{echo "0";}
		}
